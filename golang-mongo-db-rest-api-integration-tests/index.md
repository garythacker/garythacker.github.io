...
You can get all of the code samples for this blog from [this repository](https://github.com/garythacker/golang-mongo-rest-api).
...
You can check the example request and responses from the [project readme](https://github.com/garythacker/golang-mongo-rest-api).

### How to Design Integration Tests

Let's check our [PostsController](https://github.com/garythacker/golang-mongo-rest-api/blob/main/internal/controllers/controller.go) class which is basically handling all of the requests.
...
As we can see, the only dependency for the `PostsController` is the [Repository](https://github.com/garythacker/golang-mongo-rest-api/blob/main/internal/repository/repository.go). Let's check the `Repository` interface.
...
import (
	...
	"github.com/garythacker/mongoapi/internal/controllers"
	"github.com/garythacker/mongoapi/internal/repository"
	"github.com/garythacker/mongoapi/pkg/router"
)
...
- request body: https://github.com/garythacker/golang-mongo-rest-api/blob/main/internal/controllers/integration_test/requests/create_book_success.json
- response body: https://github.com/garythacker/golang-mongo-rest-api/blob/main/internal/controllers/integration_test/responses/create_book_response.json
...
Hope you enjoyed the blog. Once again, you may not grasp the whole concept by just looking at the code examples here, please check the [golang-mongo-rest-api](https://github.com/garythacker/golang-mongo-rest-api). 

You can check the other tests in the [controller_test.go](https://github.com/garythacker/golang-mongo-rest-api/blob/main/internal/controllers/integration_test/controller_test.go) file.
